...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    secondary: 'border-2 border-white bg-transparent text-white hover:bg-white/10 focus:ring-white shadow-lg',
    accent: 'bg-yellow-400 text-blue-900 hover:bg-yellow-300 focus:ring-yellow-400 font-bold shadow-lg',
  };
